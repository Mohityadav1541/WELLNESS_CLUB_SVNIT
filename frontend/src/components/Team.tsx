  ...
  const teamStructure = [
    {
      ...
      members: [
        ...
        {
          name: "Ritambhara Jangir",
          role: "Co-Chairperson, Wellness Club",
          email: "ritambhara.jangir@svnit.ac.in",
          icon: Crown,
          bio: "Co-leading the Wellness Club with dedication and inspiring holistic wellness across the SVNIT community",
          image: "/ritambhara_jangir.jpg",
          accent: "from-teal-500 to-cyan-500",
          badge:
            "from-teal-100 to-cyan-100 text-teal-800 border-teal-200",
        },
      ],
    },
    {
